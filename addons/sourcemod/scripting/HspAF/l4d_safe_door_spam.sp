...
public void OnPluginStart()
{
	...
	g_hCvarFallTime =	CreateConVar(	"l4d_safe_spam_fall_time",		"0",			"0.0=Off. How many seconds after round start (or after unlocking by l4d_safe_spam_lock* and l4d_safe_spam_lock* cvars) until the locked saferoom door will automatically fall. Unless manually opened.", CVAR_FLAGS);
	g_hCvarFreeze =		CreateConVar(	"l4d_safe_spam_freeze",			"10",			"0=Off. Any other value is the number of seconds to freeze Survivors on maps that begin without a saferoom. Also prevents players taking damage during this time.", CVAR_FLAGS);
	...
	g_hCvarGlow =		CreateConVar(	"l4d_safe_spam_glow",			"245 245 245",		"0=Off. Three values between 0-255 separated by spaces. RGB Color255 - Red Green Blue.", CVAR_FLAGS);
	...
	g_hCvarLock =		CreateConVar(	"l4d_safe_spam_lock",			"0",			"0.0=Off. How many seconds after round start will the saferoom door remain locked.", CVAR_FLAGS);
	g_hCvarLock2 =		CreateConVar(	"l4d_safe_spam_lock_2",			"0",			"0.0=Off. How many seconds after round start will the saferoom door remain locked. For the second+ round of a map.", CVAR_FLAGS);
