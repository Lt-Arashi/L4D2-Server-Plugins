...
public void OnPluginStart()
{
	...
	g_hDefaultValue = 	CreateConVar(	"l4d2_specting_cheat_default_value", 	"1", 				"By default, enable Speatator watching cheat for spectators? [1-Enable/0-Disable]", FCVAR_NOTIFY, true, 0.0, true, 1.0);
