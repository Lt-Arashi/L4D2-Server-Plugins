...
public void OnPluginStart()
{
	...
	l4d_me_slot[0] = CreateConVar("l4d_me_slot0", "1", "是否启用第二把主武器0：禁用，1启用");
	l4d_me_slot[1] = CreateConVar("l4d_me_slot1", "0", "(副武器), 0=Disable, 1=Enable");
	l4d_me_slot[2] = CreateConVar("l4d_me_slot2", "1", "(手雷), 0=Disable, 1=Enable");
	l4d_me_slot[3] = CreateConVar("l4d_me_slot3", "0", "(医疗物品), 0=Disable, 1=Enable");
	l4d_me_slot[4] = CreateConVar("l4d_me_slot4", "1", "(药品), 0=Disable, 1=Enable");
	l4d_me_mode = CreateConVar("l4d_me_mode", "1", "1=单击模式, 2=双击模式");
	l4d_me_view = CreateConVar("l4d_me_view", "0", "0=禁用第二件装备显示, 1=启用第二件装备显示");
	l4d_me_afk_save = CreateConVar("l4d_me_afk_save", "1", "0=禁用闲置保存, 1=启用闲置保存");
	l4d_me_custom_notify = CreateConVar("l4d_me_custom_notify", "0", "0=禁用自定义消息, 1=启用聊天消息, 2=启用提示消息");
	l4d_me_custom_notify_msg = CreateConVar("l4d_me_custom_notify_msg", "|| --->按 [H] 键获取帮助<--- ||", "Create a custom welcome message for your server.");
	...
	l4d_me_player_connect = CreateConVar("l4d_me_player_connect", "0", "0=禁用玩家加入提示, 1=启用玩家加入提示");
	AmmoLockSlot0 = CreateConVar("l4d_ammo_lock_slot0", "1", "0=禁用锁定0弹药, 1=启用锁定0弹药", FCVAR_NOTIFY);
	AmmoLockSlot1 = CreateConVar("l4d_ammo_lock_slot1", "0", "[如果使用有限的手枪弹药，请锁定此插槽]，0 = 禁用锁定插槽 1 弹药，1 = 启用锁定插槽 1 弹药", FCVAR_NOTIFY);
	AmmoUseDistance = CreateConVar("l4d2_ammo_pile_use_distance", "96", "这是您使用弹药堆的距离，仅用于解锁弹药", FCVAR_NOTIFY);
