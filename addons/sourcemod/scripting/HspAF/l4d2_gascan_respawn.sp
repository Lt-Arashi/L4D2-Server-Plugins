...
public void OnPluginStart()
{
    ...
    g_hCvar_CheckInterval    = CreateConVar("l4d2_gascan_respawn_check_interval", "10", "How often (in seconds) should the plugin check the scavenge gascan position.", CVAR_FLAGS, true, 0.1);
