...
public void OnPluginStart() {
	...
	cTimeout =	CreateConVar(PLUGIN_NAME ... "_timeout", "10",			"time(seconds) to disappear instructor hint, int valuve", FCVAR_NOTIFY);
	cName =		CreateConVar(PLUGIN_NAME ... "_name", "1",				"hint name prefix", FCVAR_NOTIFY);
	cIcon =		CreateConVar(PLUGIN_NAME ... "_icon", "icon_skull",		"图标样式 ./pak01_dir.vpk/scripts/mod_textures.txt", FCVAR_NOTIFY);
	cColor =	CreateConVar(PLUGIN_NAME ... "_color", "255，130，171",	"讲师提示颜色，RGB 格式", FCVAR_NOTIFY);
