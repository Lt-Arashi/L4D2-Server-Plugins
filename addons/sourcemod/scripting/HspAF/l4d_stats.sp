...
public OnPluginStart()
{
	...
	cvar_FriendlyFireMultiplier = CreateConVar("l4d_stats_ffire_multiplier", "", "Friendly fire damage multiplier (Formula: Score = Damage * Multiplier)", 0, true, 0.0);
	...
	cvar_Pills = CreateConVar("l4d_stats_pills", "0", "Base score for giving Pills to a friendly", 0, true, 1.0);
	cvar_Adrenaline = CreateConVar("l4d_stats_adrenaline", "0", "[L4D2] Base score for giving Adrenaline to a friendly", 0, true, 1.0);
	cvar_Medkit = CreateConVar("l4d_stats_medkit", "0", "Base score for using a Medkit on a friendly", 0, true, 1.0);
	...
	cvar_MedkitUsedPointPenaltyMax = CreateConVar("l4d_stats_medkitpenaltymax", "0.8", "Maximum score reduction (the score reduction will not go over this value when a Medkit is used)", 0, true, 0.0, true, 1.0);
	cvar_MedkitUsedFree = CreateConVar("l4d_stats_medkitpenaltyfree", "4", "Team Survivors can use this many Medkits for free without any reduction to the score", 0, true, 0.0);
	...
	// Misc L4D2 Cvars
	cvar_AmmoUpgradeAdded = CreateConVar("l4d_stats_deployammoupgrade", "0", "[L4D2] Base score for deploying ammo upgrade pack", 0, true, 0.0);
	cvar_GascanPoured = CreateConVar("l4d_stats_gascanpoured", "0", "[L4D2] Base score for successfully pouring a gascan", 0, true, 0.0);
