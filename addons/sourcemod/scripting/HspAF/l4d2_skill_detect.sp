...
public void OnPluginStart()
{
	...
	g_cvarRepSelfClear		= CreateConVar("sm_skill_report_sc", "0", "Enable self clear reporting.", FCVAR_NONE, true, 0.0, true, 1.0);
	g_cvarRepSelfClearShove = CreateConVar("sm_skill_report_scs", "0", "Enable self clear Shove reporting.", FCVAR_NONE, true, 0.0, true, 1.0);
	...
	g_cvarRepBhopStreak		= CreateConVar("sm_skill_report_bhop", "0", "Enable bhop streak reporting.", FCVAR_NONE, true, 0.0, true, 1.0);
	...
	g_cvarSelfClearThresh	= CreateConVar("sm_skill_selfclear_damage", "40", "How much damage a survivor must at least do to a smoker for him to count as self-clearing.", FCVAR_NONE, true, 0.0, false);
