...
public void OnPluginStart()
{
    ...
    cvar_menuOptions = CreateConVar("l4d2_menu_options", "sm_chmap,sm_v,sm_vk,sm_zs,sm_drop,sm_3rd,sm_h 3034,sm_rope,sm_hook,sm_nextstage", "Use ',' to split the command. Remember to add transitions text for it.", CVAR_FLAGS);
