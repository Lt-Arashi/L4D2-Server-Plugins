...
public void OnPluginStart()
{
	...
	Changechapter		= CreateConVar("l4d2_enabled_change_chapter", "1", "启用投票更换章节? 0=禁用, 1=启用.");
	Changedifficulty	= CreateConVar("l4d2_enabled_change_difficulty", "1", "启用投票更换难度? 0=禁用, 1=启用.");
	Changemission		= CreateConVar("l4d2_enabled_change_mission", "1", "启用投票开始新图? 0=禁用, 1=启用.");
	Changeplayerkick	= CreateConVar("l4d2_enabled_change_playerkick", "0", "启用投票踢出玩家? 0=禁用, 1=启用.");
	Changerestartgame	= CreateConVar("l4d2_enabled_change_restartgame", "1", "启用投票重新开始? 0=禁用, 1=启用.");
