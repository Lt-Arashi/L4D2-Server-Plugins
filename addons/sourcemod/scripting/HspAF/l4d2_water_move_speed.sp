...
public void OnPluginStart()
{
	...
	g_cvNormalSpeed = CreateConVar("l4d2_water_move_speed_normal", "115.0", "正常情况下生还者在水中的移动速度.");
	g_cvTankAliveSpeed = CreateConVar("l4d2_water_move_speed_tankalive", "220.0", "Tank出现时生还者在水中的移动速度.");
