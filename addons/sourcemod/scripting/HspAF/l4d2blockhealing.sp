...
{
	l4d2_blockhealing_time = CreateConVar("l4d2_blockhealing_time", "0", "How long the healing Survivor is prohibit from taking out their medkit after the receiving Survivor breaks free of the heal. 0 to disable prohibition", FCVAR_NONE);
	l4d2_blockhealing_time_ladder = CreateConVar("l4d2_blockhealing_time_ladder", "5", "How long the healing Survivor is prohibit from taking out their medkit after trying to heal a fellow Survivor on a ladder. 0 to disable prohibition", FCVAR_NONE);
	l4d2_blockhealing_time_use = CreateConVar("l4d2_blockhealing_time_use", "0", "How long the reviving Survivor is prohibit from using their use button after the incapacitated Survivor breaks free of the reviving. 0 to disable Survivors being able to break free of a revive", FCVAR_NONE);
