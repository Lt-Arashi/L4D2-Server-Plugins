...
public void OnPluginStart() { 	 
	...
	Rope_damage =		CreateConVar("rope_damage", "10", "rope damage when attack infected", FCVAR_NOTIFY);
 	Rope_distance =		CreateConVar("rope_distance", "1500.0", "rope max distance allowed", FCVAR_NOTIFY);
	...
	Access =			CreateConVar("rope_access", "", "admin flag to access rope cmd f:slay, leave empty to allow everyone", FCVAR_NOTIFY);
