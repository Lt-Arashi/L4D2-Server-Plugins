...
public void OnPluginStart()
{
    ...
    g_hCvar_Self               = CreateConVar("l4d_explosion_announcer_self", "0", "提示消息发送给点燃或引爆者?. 0=关闭, 1=开启.", CVAR_FLAGS, true, 0.0, true, 1.0);
    ...
    switch (type)
    {
        case TYPE_GASCAN:
        {
            ...
            for (int client = 1; client <= MaxClients; client++)
            {
                ...
                CPrintToChat(client, "{default}[{green}!{default}] {blue}%N {olive}引燃了汽油桶", attacker);
            }
        }
        ...
        case TYPE_FUEL_BARREL:
        {
            ...
            for (int client = 1; client <= MaxClients; client++)
            {
                ...
                CPrintToChat(client, "{default}[{green}!{default}] {blue}%N {olive}打爆了白色大油桶", attacker);
            }
        }
        ...
        case TYPE_PROPANECANISTER:
        {
            ...
            for (int client = 1; client <= MaxClients; client++)
            {
                ...
                CPrintToChat(client, "{default}[{green}!{default}] {blue}%N {olive}打爆了煤气罐", attacker);
            }
        }
        ...
        case TYPE_OXYGENTANK:
        {
            ...
            for (int client = 1; client <= MaxClients; client++)
            {
                ...
                CPrintToChat(client, "{default}[{green}!{default}] {blue}%N {olive}打爆了氧气瓶", attacker);
            }
        }
        ...
        case TYPE_BARRICADE_GASCAN:
        {
            ...
            for (int client = 1; client <= MaxClients; client++)
            {
                ...
                CPrintToChat(client, "{default}[{green}!{default}] {blue}%N {olive}引燃了路障油桶", attacker);
            }
        }
        ...
        case TYPE_GAS_PUMP:
        {
            ...
            for (int client = 1; client <= MaxClients; client++)
            {
                ...
                CPrintToChat(client, "{default}[{green}!{default}] {blue}%N {olive}打爆了汽油泵", attacker);
            }
        }
        ...
        case TYPE_FIREWORKS_CRATE:
        {
            ...
            for (int client = 1; client <= MaxClients; client++)
            {
                ...
                CPrintToChat(client, "{default}[{green}!{default}] {blue}%N {olive}点燃了烟花盒", attacker);
            }
        }
        ...
        case TYPE_OIL_DRUM_EXPLOSIVE:
        {
            ...
            for (int client = 1; client <= MaxClients; client++)
            {
                ...
                CPrintToChat(client, "{default}[{green}!{default}] {blue}%N {olive}打爆了会爆炸的大油桶", attacker);
            }
        }
    }
}
