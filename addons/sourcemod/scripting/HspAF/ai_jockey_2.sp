...
public void OnPluginStart()
{
	...
	g_hStartHopDistance = CreateConVar("ai_JockeyStartHopDistance", "1000", "Jockey 距离生还者多少距离开始主动连跳", CVAR_FLAG, true, 0.0);
	...
	g_hActionChance = CreateConVar("ai_jockeyNoActionChance", "20,15,60", "Jockey 执行以下行为的概率（冻结行动 [时间 0 - FREEZE_MAX_TIME 秒随机]，向后跳，高跳）逗号分割", CVAR_FLAG, true, 0.0, true, 100.0);
